...
describe('customer functionaly test', () => {
    ...
    it('customer add billing details', async () => {
        ...
        await loginPage.login()
        await customerPage.goToCustomerMyaccount()
        await customerPage.addBillingAddress('customer1', 'c1', 'c1company', 'c1companyID', 'c1vat', 'c1bank', 'c1bankIBAN', 'US', 'abc street', 'xyz street2', 'New York', 'NY', '1006', '0123456789', 'customer1@gamil.com')
    }, timout);
    ...
    //     await loginPage.login()
    //     await customerPage.goToCustomerMyaccount()
    //     await customerPage.addShippingAddress('customer1', 'c1', 'c1company', 'US', 'abc street', 'xyz street2', 'New York', 'NY', '1006')
    // }, timout);
