...
module.exports = {
  ...
  async setDokanSetupWizard() {
    ...
    //Recommended
    await base.check(selector.admin.dokan.dokanSetupWizard.wooCommerceConversionTracking)
    await base.check(selector.admin.dokan.dokanSetupWizard.weMail)
    await base.check(selector.admin.dokan.dokanSetupWizard.texty)
