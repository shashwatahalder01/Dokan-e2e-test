...
class QuoteRuleController extends DokanRESTController {
    ...
    public function create_quote_rule( $request ) {
        ...
        unset( $params['product_ids'], $params['category_ids'], $params['selected_user_role'] );
    ...
    public function update_quote_rule( $request ) {
        ...
        unset( $params['id'], $params['product_ids'], $params['category_ids'], $params['selected_user_role'], $params['_links'] );
